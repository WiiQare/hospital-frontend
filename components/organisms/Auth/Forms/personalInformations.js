        ...
        <Stack spacing={1.5}>
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5}>
            <div className="flex flex-col gap-1">
              ...
              formik.touched.contactPersonFirstName ? (
                renderError(formik.errors.contactPersonFirstName)
              ) : (
                <></>
              )}
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              formik.touched.contactPersonLastName ? (
                renderError(formik.errors.contactPersonLastName)
              ) : (
                <></>
              )}
            </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            formik.touched.contactPersonPhone ? (
              renderError(formik.errors.contactPersonPhone)
            ) : (
              <></>
            )}
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            formik.touched.contactPersonEmail ? (
              renderError(formik.errors.contactPersonEmail)
            ) : (
              <></>
            )}
          </div>
          ...
          <div className="flex gap-4">
            <FormControl className="w-1/2 flex flex-col gap-1">
              ...
              {formik.errors.contactPersonOccupation &&
              formik.touched.contactPersonOccupation ? (
                renderError(formik.errors.contactPersonOccupation)
              ) : (
                <></>
              )}
            </FormControl>
            ...
            <div className="flex flex-col gap-1">
              ...
              {formik.errors.contactPersonHomeAddress &&
              formik.touched.contactPersonHomeAddress ? (
                renderError(formik.errors.contactPersonHomeAddress)
              ) : (
                <></>
              )}
            </div>
