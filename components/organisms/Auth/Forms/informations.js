...
function Information() {
  ...
  const onSubmit = async (values) => {
    ...
    dispatch(
      setRegister({
        ...info,
        emailVerificationToken: query['email-verification'],
      }),
    );
    handleComplete();
  };
        ...
        <Stack spacing={1.5}>
          <FormControl fullWidth>
            ...
            <Select
              ...
              label="Type Business"
              onChange={(e) =>
                formik.setFieldValue('businessType', e.target.value)
              }
            >
            ...
            {formik.errors.businessType && formik.touched.businessType ? (
              renderError(formik.errors.businessType)
            ) : (
              <></>
            )}
          </FormControl>
          ...
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5}>
            ...
            <div className="flex flex-col gap-1">
              ...
              {formik.errors.postalCode && formik.touched.postalCode ? (
                renderError(formik.errors.postalCode)
              ) : (
                <></>
              )}
            </div>
          ...
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5}>
            <div className="flex flex-col gap-1">
              ...
              {formik.errors.nationalId && formik.touched.nationalId ? (
                renderError(formik.errors.nationalId)
              ) : (
                <></>
              )}
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              {formik.errors.businessRegistrationNo &&
              formik.touched.businessRegistrationNo ? (
                renderError(formik.errors.businessRegistrationNo)
              ) : (
                <></>
              )}
            </div>
