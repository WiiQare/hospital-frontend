...
function Email() {
    ...
    const renderError = (message) => (
		<span className="flex items-center gap-1 text-rose-500 text-left text-xs px-1"><HiOutlineInformationCircle /><span>{message}</span></span>
	);
...

            {
                !complete ? (
                        ...
                        <form id="signupform" onSubmit={formik.handleSubmit}>
                            <Stack spacing={2}>
                                ...
                                <div className="flex flex-col gap-1">
                                    ...
                                    {formik.errors.confirm_password && formik.touched.confirm_password  ?  renderError(formik.errors.confirm_password): <></>}
                                </div>
                    ...
                    <div className="flex flex-col gap-3 items-center mt-14">
                        <Image src={"https://i.goopics.net/fuiyr8.png"} width={80} height={80} className="w-28 opacity-90" />
                        <span className="text-xs text-gray-400 ">Un mail vous a été envoyé à votre adresse email, pour continuer l'inscription</span>
                    </div>
                )
            }
        </>
