...
const Service = () => {
  ...
  const {
    ...
    `/provider/${data.user.data.providerId}/service`,
    data.accessToken,
  );
  ...
  const onSubmit = async (values) => {
    ...
    newServiceMutation.mutate({
      ...values,
      providerId: data.user.data.providerId,
  ...
  const ValidationSchema = yup.object().shape({
    ...
    price: yup
      .number('Le prix doit être numérique')
              ...
              <>
                ...
                {selected.length > 0 ? (
                  <div className="absolute bottom-2 px-10">
                    <button
                      className=" bg-orange text-xs md:text-sm py-2 px-4 rounded-lg effect-up text-white shadow"
                      onClick={() => openModalForPackage()}
                    >
                      + Créer un package
                    </button>
                  </div>
              ...
              <div className="py-10 mx-auto w-1/2 flex flex-col justify-center items-center gap-4">
                <div className="flex justify-center items-center">
                  <img
                    ...
                    alt=""
                    className="w-40 opacity-80 object-cover"
                  />
                </div>

                <p className="text-gray-500 text-sm">
                  Aucun service actuellement ajouté...
                </p>
                <button
                  onClick={() => openModal()}
                  className="bg-orange text-white text-sm px-3 py-2.5 rounded-lg effect-up shadow-sm font-medium flex"
                >
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        {formik.errors.price && formik.touched.price ? (
                          renderError(formik.errors.price)
                        ) : (
                          <></>
                        )}
                      </div>
              ...
              <div className="flex items-center justify-center min-h-full p-4 text-center">
                ...
                >
                  <Dialog.Panel className="w-full max-w-md p-6 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-xl space-y-10">
                    ...
                    <form
                      className="flex w-full  gap-4 flex-col"
                      onSubmit={formikPackage.handleSubmit}
                    >
                      <div className="flex flex-col gap-1">
                        <TextField
                          fullWidth
                        ...
                        {formikPackage.errors.name &&
                        formikPackage.touched.name ? (
                          renderError(formikPackage.errors.name)
                        ) : (
                          <></>
                        )}
                      </div>
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        {formikPackage.errors.price &&
                        formikPackage.touched.price ? (
                          renderError(formikPackage.errors.price)
                        ) : (
                          <></>
                        )}
                      </div>
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        />
                        {formikPackage.errors.description &&
                        formikPackage.touched.description ? (
                          renderError(formikPackage.errors.description)
                        ) : (
                          <></>
                        )}
                      </div>
                          ...
                          <tbody>
                            {selected.map((service) => (
                              <tr className="bg-white border-b hover:bg-gray-50">
                                <th
                                  scope="row"
                                  className="px-6 py-4 font-medium text-xs text-gray-900 whitespace-nowrap"
                                >
                                  {service.name}
                                </th>
                                ...
                                <td className="px-6 py-4">
                                  <button className="font-medium text-blue-600 hover:underline text-xs">
                                    Rétirer
                                  </button>
                                </td>
                              </tr>
