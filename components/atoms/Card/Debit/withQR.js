    ...
    <CardWrap className="flex !w-full md:!w-[40rem] h-full">
      <div className="v-card cardLeft shadow-sm !w-4/6">
        ...
        <div className="price relative flex items-center justify-center w-full h-fit -mb-4">
          <h3 className="!text-2xl md:!text-3xl flex justify-center items-center">
            $
            <input
              type="text"
              defaultValue={'200.00'}
              className="w-28 p-0 text-3xl border-none focus:ring-0 pointer-events-none "
              id="voucherAmount"
            />
          </h3>
          <label htmlFor="voucherAmount" className="cursor-pointer">
            <CiEdit
              size={20}
              className=" text-gray-800 hover:text-orange transition-all duration-200"
            />
          </label>
        </div>
        ...
        <div className="scan !w-full !flex !justify-around">
          ...
          <div className="md:hidden">
            <ButtonBuy
              href={`/voucher/buy`}
              title={'Buy now'}
              className="text-white mr-3 md:mr-0"
              withIcon={false}
            />
          </div>
        </div>
