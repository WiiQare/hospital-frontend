    ...
    return (
        <div className="flex ">
            <div class="w-full p-2 lg:w-1/4 md:w-1/2">
                <div
                    class="flex flex-col px-6 py-10 overflow-hidden bg-white hover:bg-gradient-to-br hover:from-purple hover:via-orange hover:to-primary transition-all rounded-xl shadow-lg duration-300 hover:shadow-2xl group">
