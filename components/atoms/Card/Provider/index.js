    ...
    <div className="border hover:shadow rounded-lg py-4 px-5 flex flex-col md:flex-row justify-between gap-6 bg-white cursor-pointer">
      ...
      <div className="flex gap-3">
        <div className="w-32 h-24 md:w-40 md:h-32 border rounded-lg overflow-hidden">
          <Image
            src={bima}
            className="objectif-cover w-full h-full"
            alt="bima"
          />
        </div>
      ...
      <div className="space-y-2">
        <span className="py-1 px-2 rounded-full bg-[rgba(254,128,35,.3)] text-xs text-gray-700 font-light flex items-center gap-2 w-fit">
          TeleHealth <CiCircleInfo size={18} />
        </span>
        <ul className="space-y-2 w-64">
          <li className="flex items-center gap-2 text-xs text-gray-700 font-light">
            <FcCheckmark size={18} /> Consultation Service 24/7 - Generalists
            and Specialists
          </li>
          <li className="flex items-center gap-2 text-xs text-gray-700 font-light">
            <FcCheckmark /> Insurance Benefits GHC 76,000
          </li>
          <li className="flex items-center gap-2 text-xs text-gray-700 font-light">
            <FcCheckmark /> Medication Benefits GHC 180
          </li>
        </ul>
      </div>
      ...
      <div className="text-gray-700 flex md:block items-center gap-4 space-y-2">
        ...
        <h3 className="text-2xl font-semibold">
          $12.15<span className="font-extralight text-lg">/mo</span>
        </h3>
